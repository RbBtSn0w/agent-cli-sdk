...
import json
import inspect
from typing import List, Callable, Optional, AsyncGenerator, Dict, Any
from .types import Message, Role, ToolDefinition, StreamEvent, AgentEvent
        ...
        for _ in range(max_turns):
            ...
            async for event in self._driver.chat(self._history):
                ...
                if event.type == AgentEvent.TOOL_CALL:
                    ...
                    yield StreamEvent(type=AgentEvent.TOOL_RESULT, payload={
            ...
            # If the last stream didn't result in more tool calls, the conversation turn is complete
