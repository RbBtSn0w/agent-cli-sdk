...
class MockDriver(AgentDriver):
    ...
    async def chat(self, messages: List[Message]) -> AsyncGenerator[StreamEvent, None]:
        ...
        if last_message.role == Role.TOOL:
            ...
            yield StreamEvent(type=AgentEvent.THOUGHT, payload="I received the tool output.")
        ...
        if "weather" in content:
            ...
            yield StreamEvent(type=AgentEvent.THOUGHT, payload="I need to check the weather.")
